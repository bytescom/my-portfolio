    ...
    <Background>
      <div className="min-h-screen w-full">
        <div className="w-full">
          ...
          <div className="h-full mx-[8rem] py-[4rem] border-white border-x-[2px] dash-v">
        ...
        {/* border  */}
        <div className='border-white border-t-[2px] dash-h w-full'></div>
        ...
        <footer className='w-full flex justify-center items-center border-white border-y-[2px] dash-h'>
          <div class="py-[3rem] w-full flex flex-col items-center mx-[8rem] border-white border-x-[2px] dash-v">
            <p>Got an idea that's wild, unique, or groundbreaking? Let's bring it to together. <a href="#"> Let's
              Talk!</a></p>
            <p>2023 © Pankaj Kumar | All Rights Reserved</p>
          </div>
        </footer>
      </div>
    </Background>
